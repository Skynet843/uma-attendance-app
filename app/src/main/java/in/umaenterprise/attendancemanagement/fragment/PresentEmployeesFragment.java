...
import in.umaenterprise.attendancemanagement.adapter.PresentEmployeesAdapter;
...
public class PresentEmployeesFragment extends Fragment implements View.OnClickListener {
    ...
    private void init(View view) {
        ...
        mAdapter = new PresentEmployeesAdapter(getActivity(),
            ...
            @Override
            public void onItemClick(AttendanceModel attendanceModel,boolean flag) {
                ...
                if(flag){
                    ...
                    bundleImages.putSerializable("attendanceModel",attendanceModel);
                    ...
                    .subscribe(pairs -> {
                        ...
                        for (Pair<PersonModel, AttendanceModel> pair : pairs) {
                            ...
                            if (attendanceModel != null) {
                                ...
                                personModel.setPunchInTimeS2(attendanceModel.getPunchInTimeS2());
                                personModel.setPunchOutTimeS2(attendanceModel.getPunchOutTimeS2());
                                ...
                                personModel.setPunchInImages(attendanceModel.getPunchInImage());
                                personModel.setPunchOutImages(attendanceModel.getPunchOutImage());
                                personModel.setPunchInImagesS2(attendanceModel.getPunchInImageS2());
                                personModel.setPunchOutImagesS2(attendanceModel.getPunchOutImageS2());
