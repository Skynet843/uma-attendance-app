...
import in.umaenterprise.attendancemanagement.BuildConfig;
...
import in.umaenterprise.attendancemanagement.activity.OnBoardingActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_rate_us:
                CommonMethods.rateApplication(Objects.requireNonNull(getActivity()));
                break;
            ...
            case R.id.ll_share_app:
                final String shareappPackageName = Objects.requireNonNull(getActivity()).getPackageName();
